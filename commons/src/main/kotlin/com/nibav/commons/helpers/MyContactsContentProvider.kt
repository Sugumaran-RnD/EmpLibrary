package com.nibav.commons.helpers
...
import com.nibav.commons.extensions.getIntValue
import com.nibav.commons.extensions.getStringValue
import com.nibav.commons.models.PhoneNumber
import com.nibav.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.nibav.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.nibav.dialer" && packageName != "com.nibav.smsmessenger" && packageName != "com.nibav.calendar.pro") {
                return contacts
            }
