...
import com.nibav.commons.adapters.ManageBlockedNumbersAdapter
import com.nibav.commons.databinding.ActivityManageBlockedNumbersBinding
import com.nibav.commons.dialogs.AddBlockedNumberDialog
import com.nibav.commons.dialogs.ExportBlockedNumbersDialog
import com.nibav.commons.dialogs.FilePickerDialog
import com.nibav.commons.extensions.*
import com.nibav.commons.helpers.*
import com.nibav.commons.interfaces.RefreshRecyclerViewListener
...
class ManageBlockedNumbersActivity : BaseSimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun setupBlockHidden() {
        val blockHiddenTitleRes =
            if (baseConfig.appId.startsWith("com.nibav.dialer")) R.string.block_hidden_calls else R.string.block_hidden_messages
    ...
    private fun setupBlockUnknown() {
        val blockUnknownTitleRes =
            if (baseConfig.appId.startsWith("com.nibav.dialer")) R.string.block_not_stored_calls else R.string.block_not_stored_messages
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.nibav.dialer")) {
