...
import com.nibav.commons.models.AlarmSound
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.nibav.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.nibav.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.nibav.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.nibav."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.nibav.contacts") && !packageName.startsWith("com.nibav.dialer")) {
        true
    } else if ((packageName.startsWith("com.nibav.contacts") || packageName.startsWith("com.nibav.dialer")) && isQPlus()) {
