...
import com.nibav.commons.extensions.beVisibleIf
import com.nibav.commons.interfaces.ItemMoveCallback
import com.nibav.commons.interfaces.ItemTouchHelperContract
import com.nibav.commons.interfaces.StartReorderDragListener
import com.nibav.commons.samples.databinding.ListItemBinding
...
class StringsAdapter(
    ...
    override fun getActionMenuId() = com.nibav.commons.R.menu.cab_delete_only
    ...
    override fun actionItemPressed(id: Int) {
        ...
        when (id) {
            com.nibav.commons.R.id.cab_delete -> changeOrder()
        }
    }
